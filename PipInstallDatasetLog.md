...
Requirement already satisfied: httpcore==1._ in c:\users\lihen\anaconda3\lib\site-packages (from httpx<1.0.0->datasets) (1.0.9)
Requirement already satisfied: idna in c:\users\lihen\anaconda3\lib\site-packages (from httpx<1.0.0->datasets) (3.7)
Requirement already satisfied: h11>=0.16 in c:\users\lihen\anaconda3\lib\site-packages (from httpcore==1._->httpx<1.0.0->datasets) (0.16.0)
